...
for field in fields:    
    ...
    if field == 'EN1':
        ...
        ft = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1_final_cross_match_catalogue-v0.7_mergenew.fits'
        ftoutlier = '/beegfs/lofar/deepfields/science_ready_catalogs/EN1_opt_spitzer_merged_vac_opt3as_irac4as_all_hpx_public.fits'
        
        ftout = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1_final_cross_match_catalogue-v0.7_mergenew_outlier.fits'
        
    elif field == 'LH':
        ft = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/LH_final_cross_match_catalogue-v0.7_mergenew.fits'
        ftoutlier = '/beegfs/lofar/deepfields/science_ready_catalogs/LH_opt_spitzer_merged_vac_opt3as_irac4as_all_hpx_public.fits'
        
        ftout = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/LH_final_cross_match_catalogue-v0.7_mergenew_outlier.fits'
        
    elif field == 'Bootes':
        ft = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_final_cross_match_catalogue-v0.7_mergenew.fits'
        ...
        ftout = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_final_cross_match_catalogue-v0.7_mergenew_outlier.fits'
