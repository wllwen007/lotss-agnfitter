...
rcat = Table.read('science_ready_catalogs/Bootes_opt_spitzer_merged_vac_opt3as_irac4as_all_hpx_public.fits')
C=SkyCoord(rcat['RA'],rcat['DEC'])
t=mocmips.contains(C.ra, C.dec)

rcat = Table.read('science_ready_catalogs/LH_opt_spitzer_merged_vac_opt3as_irac4as_all_hpx_public.fits')
C=SkyCoord(rcat['RA'],rcat['DEC'])
t=mocmips.contains(C.ra, C.dec)
