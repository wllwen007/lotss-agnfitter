def CATALOG_settings():
    ...
    ***USER INPUT NEEDED***
    ...
    cat['outpath'] ='/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/LH_v0.6/'
    
    cat['filename'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/LH_agnfitter_v0.6.fits'
    ...
    cat['dict_path'] = cat['outpath']+'/MODELSDICT_LH'
...
def FILTERS_settings():
    ...
    filters['file'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/LH_agnfitter_filters.lst' 
