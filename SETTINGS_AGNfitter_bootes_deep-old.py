...
def CATALOG_settings():
    ...
    ***USER INPUT NEEDED***
    ...
    ##GENERAL
    cat['path'] ='/home/wwilliams/git/AGNfitter/'  #path to the AGNfitter code


    cat['filename'] = cat['path']+'data/ML_RUN1_srl_ionly_AllData.fits'
    cat['filetype'] = 'fits' ## catalog file type: 'ASCII' or 'FITS'. 
                              ## FITS option not available yet. 

    cat['name'] = 'ID'            ## If ASCII: Column index (int) of source IDs
                                        ## If FITS: not yet
    cat['redshift'] = 'z'              ## If ASCII:  Column index(int) of redshift
                                        ## If FITS: not yet
    ...
    cat['workingpath'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/'  # Allows for a working path other than the AGNfitter code path.
                                      # Will include:
