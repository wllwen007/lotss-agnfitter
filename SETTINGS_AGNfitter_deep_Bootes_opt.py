def CATALOG_settings():
    ...
    ***USER INPUT NEEDED***
    ...
    cat['outpath'] ='/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_opt/'
    
    cat['filename'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_opt_agnfitter.fits'
    ...
    cat['dict_path'] = cat['outpath']+'/MODELSDICT_Bootes_opt'
...
def FILTERS_settings():
    ...
    filters['file'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_opt_agnfitter_filters.lst' 
