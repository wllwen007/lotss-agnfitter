def CATALOG_settings():
    ...
    ***USER INPUT NEEDED***
    ...
    cat['outpath'] ='/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1_opt/'
    
    cat['filename'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1_opt_agnfitter.fits'
    ...
    cat['dict_path'] = cat['outpath']+'/MODELSDICT_EN1_opt'
...
def FILTERS_settings():
    ...
    filters['file'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1_opt_agnfitter_filters.lst' 
