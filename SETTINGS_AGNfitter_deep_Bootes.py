def CATALOG_settings():
    ...
    ***USER INPUT NEEDED***
    ...
    cat['outpath'] ='/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_v0.6/'
    
    cat['filename'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_agnfitter_v0.6.fits'
...
def FILTERS_settings():
    ...
    filters['file'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/Bootes_agnfitter_filters.lst' 
