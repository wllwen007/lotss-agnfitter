def CATALOG_settings():
    ...
    ***USER INPUT NEEDED***
    ...
    cat['outpath'] ='/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1/'
    
    cat['filename'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1_agnfitter.fits'
    ...
    cat['dict_path'] = cat['outpath']+'/MODELSDICT_EN1'
...
def FILTERS_settings():
    ...
    filters['file'] = '/beegfs/lofar/wwilliams/lofar_surveys/deep/agnfitter/EN1_agnfitter_filters.lst' 
